...
class Selenium2OnSauce(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver = webdriver.Remote(
            ...
            command_executor="http://benknight:e79adc51-da8e-435f-beb6-af530ec75a3f@ondemand.saucelabs.com:80/wd/hub"
        )
        self.driver.implicitly_wait(30)

    def test_sauce(self):
        self.driver.get('http://saucelabs.com/test/guinea-pig')
        self.assertTrue("I am a page dfasdfatitle - Sauce Labs" in self.driver.title)
